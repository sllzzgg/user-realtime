...
function imagesBodyScroll() {
	st = $(window).scrollTop(),
	st > 200 && !newShow ? ($(".news").show(), newShow = !0) : 200 >= st && newShow && ($(".news").hide(), newShow = !1),
	500 > st && (imagesBody.css({
			opacity : 1 - st / 1e3,
		...
		}), imsageArrow.css("opacity", .5 - st / 250))
}
var st = 0, imagesBody = null, imsageArrow = null, chart = null, stock = null, map = null, newShow = !1, _coverVid = function (e, n, a) {
	function t(e, n) {
		var a = null;
		return function () {
			var t = this,
	...
	function o() {
		...
		l = t / r,
		s = o / i;
		s > l ? (e.style.height = "auto", e.style.width = o + "px") : (e.style.height = t + "px", e.style.width = "auto")
	}
	o(),
	window.addEventListener("resize", t(o, 50)),
	e.style.position = "absolute",
	e.style.top = "50%",
	e.style.left = "50%",
	e.style["-webkit-transform"] = "translate(-50%, -50%)",
	e.style["-ms-transform"] = "translate(-50%, -50%)",
	e.style.transform = "translate(-50%, -50%)",
	e.parentNode.style.overflow = "hidden";
	var i = e.getAttribute("poster");
	e.removeAttribute("poster"),
	e.parentNode.style.backgroundImage = "url(" + i + ")",
	e.parentNode.style.backgroundSize = "cover",
	e.parentNode.style.backgroundPosition = "center center";
	var r = "undefined" != typeof e.canPlayType,
	l = !1;
	(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent) || /1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(navigator.userAgent.substr(0, 4))) && (l = !0),
	r && !l || e && e.parentNode && e.parentNode.removeChild(e)
};
window.jQuery && jQuery.fn.extend({
	coverVid : function () {
		return _coverVid(this[0], arguments[0], arguments[1]),
		this
	}
}), 
$(document).ready(function () {
	imageConverFull(),
	$(window).resize(imageConverFull),
	imagesBody = $(".images-body"),
	imsageArrow = $(".images-arrow"),
	$(window).scroll(imagesBodyScroll)
	...
	credits : {
		...
		href : "http://highcharts.com.cn"
	},
	lang : {
		downloadJPEG : "保存 JPG 图片",
		downloadPNG : "保存 PNG 图片",
		downloadPDF : "保存 PDF 文件",
		downloadSVG : "保存 SVG 图片",
		printChart : "打印图表",
	...
	function n(n) {
		var a = this,
		t = e(this.chart.container.parentNode);
		!t.is(":appeared") && a.options.animation || n.call(a),
		t.each(function () {
			e(this).appear(),
			e(this).on("appear", function () {
				n.call(a),
				e(this).unbind()
			})
		})
	...
	if (e(document).width() >= 768) {
		var a = Highcharts.Series.prototype.render;
		Highcharts.wrap(Highcharts.Series.prototype, "render", n),
		e(window).bind("resize", function () {
			Highcharts.Series.prototype.render = a
		})
	}
	var t = 1517;
	if (e("#highcharts-demo-box .demo-frame-container").highcharts({
			colors : ["#B7FFB5", "#fff", "#f45b5b", "#7798BF", "#aaeeee", "#ff0066", "#eeaaee", "#55BF3B", "#DF5353", "#7798BF", "#aaeeee"],
			credits : {
				enabled : !1
			},
			chart : {
			...
			tooltip : {
				formatter : function () {
					return "日照" == this.series.name ? "<b>" + this.point.name + "：</b> " + this.y : "" + this.x + "： " + this.y + ("降雨量" == this.series.name ? " mm" : "°C")
				}
			},
			series : [{
					name : "降雨量",
		...
		}), e.getJSON("http://datas.org.cn/jsonp?filename=json/aapl-ohlcv.json&callback=?", function (n) {
			var a = 1517,
			t = "#D2E9FF",
			o = [],
			i = [],
			r = n.length,
			l = [["week", [1]], ["month", [1, 2, 3, 4, 6]]],
			s = 0;
			for (s; r > s; s += 1)
				o.push([n[s][0], n[s][1], n[s][2], n[s][3], n[s][4]]) , i.push([n[s][0], n[s][5]]);
				e("#highstock-demo-box").find(".demo-frame-container").highcharts("StockChart", {
					colors : ["#FFF", "#FFF", "#f45b5b", "#7798BF", "#aaeeee", "#ff0066", "#eeaaee", "#55BF3B", "#DF5353", "#7798BF", "#aaeeee"],
					credits : {
						enabled : !1
					},
					chart : {
			...
			r = Highcharts.maps["cn-with-city"],
			l = Highcharts.geojson(r, "mappoint");
			e("#highmaps-demo-box .demo-frame-container").highcharts("Map", {
				colors : ["#323C48", "#19E1CF", "#f45b5b", "#7798BF", "#aaeeee", "#ff0066", "#eeaaee", "#55BF3B", "#DF5353", "#7798BF", "#aaeeee"],
				credits : {
					enabled : !0,
					text : "",
					style : {
				...
				colorAxis : {
					min : 0,
					stops : [[0, "#EFEFFF"], [.5, Highcharts.getOptions().colors[0]], [1, "#006cee"]]
				},
				legend : {
					enabled : !0,
					layout : "vertical",
				...
				tooltip : {
					...
					pointFormatter : function () {
						...
						var e = "<tr><td>用户名称：</td><td>";
						//return e += "circle" === this.shapeType ? this.z + "</b> 万</td></tr>" : (this.value || "-") + "</b> 千万</td></tr><tr><td>排名：</td><td><b>" + (this.rank || "-") + "</b></td></tr>"
						return e += (this.phone || "-") + "</td></tr><tr><td>正在搜索：</td><td><b style=\"color:#F89408;\">" + (this.rank || "-") + "</b></td></tr>"
					},
					footerFormat : "</table>"
				},
				...
				keywords(n,a);
				//启动websocket
				var ws = new WebSocket("ws://192.168.2.247:8080/user-realtime/keyWordWebsocket");
				//var ws = new WebSocket("ws://localhost:8080/user-realtime/keyWordWebsocket");
...
//用户信息
function getUserInfo(userId,kwd,n,a,e){
	$.ajax({
		url: 'serachById', // 跳转到 action   
		type: 'post',
		cache: false,
		data:{userId:userId},
		dataType: 'json',
		success: function(data) {
			if (data.success) {
				...
				for(var i=0;i<a;i++){
					if(userInfo.parentName == n.data[i].name){
						n.data[i].phone = userInfo.phone;
						n.data[i].rank = kwd;
						n.data[i].citytype = 0;
						e.tooltip.refresh(n.data[i]);
						changeNum(kwd);
						return false;
					}
				}
...
function keywords(n,a){
	$.ajax({
		url: 'serachKeyWordGroupByProvice', // 跳转到 action   
		type: 'post',
		cache: false,
		dataType: 'json',
		success: function(data) {
			if (data.success) {
				...
				for(var g=0; g<results.length;g++){
					for(var k=0;k<a;k++){
						var cityId = n.data[k].id;
						if(cityId == results[g].parentid){
							n.data[k].value = results[g].sumNum;
						}
					}
...
function changeNum(kwd){
	//累计访问量
	var num1 = $("#keyWord1").text();
	num1 = parseInt(num1) + 1;
	$("#keyWord1").html(num1);
	
	//今日访问次数
	var num3 = $("#keyWord3").text();
	num3 = parseInt(num3) + 1;
	$("#keyWord3").html(num3);
	//热搜商品
	$("li[key="+kwd+"]").each(function(i,item){
		var numDiv = $(item).find("div").eq(1);
